# L2: Setup & Codebase Understanding

## How to Run the RAG Chatbot Application?
- Fork this [repo](https://github.com/the-schoolofai/ragchatbot)
- Clone the forked repo to your local machine
- Follow the instructions in the [README.md file](https://github.com/the-schoolofai/ragchatbot/blob/main/README.md):
...
- `/init`: Claude Code scans your codebase and creates CLAUDE.md file inside your project directory.
    ...
    - Here's an [example](https://github.com/the-schoolofai/ragchatbot/blob/main/CLAUDE.md) of a CLAUDE.md file generated by `init` for the RAG chatbot example.
